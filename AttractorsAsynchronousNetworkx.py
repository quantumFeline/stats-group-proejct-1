...
class AsyncAnalyzerNX:
    ...
    def print_summary(self):
        ...
        for i, attr in enumerate(self.attractors):
            print(f"  Attractor {i}: {len(attr)} states")
    ...
    def print_attractors_binary(self):
        ...
        for i, attr in enumerate(self.attractors):
            ...
            for state in sorted(attr):
                print("    ", self.network.int_to_binary(state))
    ...
    def print_state_info(self):
        ...
        for state in range(self.num_states):
            ...
            print(f"State {state} (binary {bin_state}): is_attractor={info['is_attractor']}, attractor_id={info['attractor_id']}")
