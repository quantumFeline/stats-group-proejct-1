...
The ground truth network representations are located in the \texttt{ground\_truth\_networks} directory.
Example datasets (input files for BNFinder2) are available in the \texttt{datasets} directory. Only datasets for the 10-node network are included in the repository for demonstration purposes; the remaining datasets are stored locally.\newline\newline
...
Example BNFinder2 results are available in the \texttt{results} directory. Only results for the 10-node network are included in the repository for demonstration purposes; the remaining result files are stored locally.\newline\newline
\noindent
...
(Hamming distance normalized, Structural Hamming distance normalized, precision, recall, and F1 score)
