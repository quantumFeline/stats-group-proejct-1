...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{plots_tsv_sync/metrics_by_len}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{plots_tsv_sync/metrics_by_tf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{plots_tsv_sync/metrics_by_sf}
